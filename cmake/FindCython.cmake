...
#
# ``Cython::Cython`` The Cython executable
#
...
# Use the Cython executable that lives next to the Python executable if it is a
# local installation.
...
find_package_handle_standard_args(
  ...
  VERSION_VAR ${CYTHON_VERSION} ${_handle_version_range})

if(CYTHON_FOUND)
  if(NOT DEFINED Cython::Cython)
    add_executable(Cython::Cython IMPORTED)
    set_target_properties(Cython::Cython PROPERTIES IMPORTED_LOCATION
                                                    "${CYTHON_EXECUTABLE}")
  endif()
endif()
